...
const PERK_REQUIREMENTS = {
  action_boy: {},
  basher: { strength: 6 },
  black_widow: { charisma: 6 },
  cap_collector: { charisma: 5 },
  comprehension: { intelligence: 6 },
  demolition_expert: { perception: 6, luck: 6 },
  hacker: { intelligence: 8 },
  inspirational: { charisma: 8 },
  medic: { intelligence: 8 },
  mysterious_stranger: { luck: 7 },
  nuclear_physicist: { intelligence: 9 },
  scoundrel: { charisma: 7 },
  adrenaline_rush: { strength: 7 },
  better_criticals: { luck: 9 },
  bloody_mess: { luck: 6 },
  cautious_nature: { perception: 7 },
  concentrated_fire: { perception: 8, agility: 6 },
  faster_healing: { endurance: 6 },
  hunter: { endurance: 6 },
  junktown_jerky_vendor: { charisma: 8 },
  mister_sandman: { agility: 9 },
  night_person: { perception: 7 },
  party_boy: { endurance: 6, charisma: 7 },
  size_matters: { endurance: 7, agility: 6 },
  solar_powered: { endurance: 7 },
  awareness: { perception: 7 },
  big_leagues: { strength: 8 },
  can_do: { luck: 5 },
  chemist: { intelligence: 7 },
  daring_nature: { luck: 7 },
  grim_reapers_sprint: { luck: 8 },
  infiltrator: { perception: 8 },
  light_step: {},
  moving_target: { agility: 9 },
  ninja: { agility: 8 },
